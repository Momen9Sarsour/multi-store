                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            ...
                            {{-- <li><a href="{{ route('productss.index') }}">Shop</a></li> --}}
                            <li><a>Shop</a></li>
                            <li>{{ $product->name }}</li>
                        </ul>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ $product->image_url }}" id="current" alt="No Imgae Products">
                                </div>
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price" style="color: green">{{ $product->price}}$@if($product->compare_price)<span style="color: red">{{ $product->compare_price }}$</span>@endif</h3>
